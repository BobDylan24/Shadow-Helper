...
@bot.slash_command(name="reaction", description="Reaction", guild_ids=[1062880883423584298])
@commands.is_owner()
async def reaction(ctx):
    class MyView(discord.ui.View):
        ...
        async def first_button_callback(self, button, interaction):
            ...
            await ctx.author.send("Added you to the Bot Updates Role.")
        ...
        async def second_button_callback(self, button, interaction):
            ...
            role = discord.utils.get(ctx.guild.roles, id=role_id)
            await ctx.author.send("Added you to the Github Updates Role.")
            await bot.add_roles(ctx.author, role)
            return
        ...
        async def third_button_callback(self, button, interaction):
            ...
            role = discord.utils.get(ctx.guild.roles, id=role_id)
            await ctx.author.send("Added you to the Giveaway Ping Role.")
            await bot.add_roles(ctx.author, role)
            return
        ...
        async def fourth_button_callback(self, button, interaction):
            ...
            role = discord.utils.get(ctx.guild.roles, id=role_id)
            await ctx.author.send("Added you to the Announcement Ping Role.")
